...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    @if(Session::get('memberName', 'default') != "default")
                    <li><a href={{ url('/logoutpage') }}>登出</a></li>
                    <li><a href={{ url('/memberpage') }}>會員專區</a></li>
                    @else
    ...
    <div class="jumbotron">
        <div class="container">
            <h1 align = "center">線上財務管理-測試</h1>
            <br>
            <!--{{ Session::get('memberName')? url('logoutpage') : url('loginpage') }}-->
        </div>
    </div>
