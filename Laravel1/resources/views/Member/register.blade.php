    ...
    <div class="container">
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
          ...
          <table width="300" border="1" align="center" cellpadding="5" cellspacing="0" bgcolor="#F2F2F2">
            ...
            <tr>
              <td width="100" align="center" valign="baseline">會員信箱：</td>
              <td valign="baseline"><input type="text" name="loginEmail"></td>
            </tr>
            <tr>
              <td width="100" align="center" valign="baseline">會員生日：</td>
              <td valign="baseline"><input type="text" name="loginDate"></td>
            </tr>
            <tr>
